        ...
        <div class="container mt-5">
            <div class="row" style="justify-content: center">
                ...
                <div class="col-md-3">
                    ...
                    <form method="post" action="?c=home&a=singleOffer">
                        <input type="hidden" name="parid" value="<?=$post->getId()?>">
                        <button class="btn btn-primary" style="background: none; color:#64496d; border-color: white" class="floated" type="submit">
                ...
                <div class="col-md-3">
                    ...
                    <p>Tu môže byť vaša ponuka. Stačí kliknúť vyššie na "Pridaj nový inzerát" a vyplniť krátky formulár vašich požiadaviek.</p>
                    <?php } else {?>
                    <p>Tu môže byť vaša ponuka. Stačí sa zaregistrovať a vyplniť krátky formulár vašich požiadaviek.</p>
                    <?php }?>
                </div>
